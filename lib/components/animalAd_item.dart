...
class AnimalAdItem extends StatelessWidget {
  final AnimalAdModel animalAd;
  const AnimalAdItem(this.animalAd, { super.key});
  @override
  Widget build(BuildContext context) {
  String? loggedEmail = Auth.emailUserForm;
    bool verify;
  if(loggedEmail == animalAd.emailUser || loggedEmail == 'jana@gmail.com')
  verify = true;
  else
  verify = false;
    return ListTile(
      leading: CircleAvatar(
        backgroundImage: NetworkImage(animalAd.imagem),
      ),
          ...
          children: [
            IconButton(
              ...
              onPressed: !verify ? null :(){
                Navigator.of(context).pushNamed(AppRoutes.ANIMALADFORM, arguments: animalAd);
              }, 
            ),
            IconButton(
                  ...
                  builder: (ctx) =>AlertDialog(
                    ...
                    actions: [
                      ...
                      TextButton(
                        child: Text('Sim'),
                        onPressed: () { 
                          Provider.of<AnimalAdList>(context, listen: false).removeAnimalAd(animalAd);
